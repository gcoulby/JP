...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\/windowmap.c:1: unsigned char windowmap[] =
	...
	ld	(hl), #0x23
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\/game_over_map.c:1: unsigned char gameOverMap[] =
	ld	hl, #_gameOverMap
	ld	(hl), #0x1a
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\/welcomemap.c:1: unsigned char welcomemap[] =
	...
	ld	(hl), #0x1e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\/Splash.c:25: unsigned char Splash[] =
	ld	hl, #_Splash
	ld	(hl), #0x00
	...
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\/SplashTiles.c:26: unsigned char SplashTiles[] =
	ld	hl, #_SplashTiles
	ld	(hl), #0x00
	...
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:25: BYTE jumping = 0;
	ld	hl, #_jumping
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:26: UBYTE spriteSize = 8;
	ld	hl, #_spriteSize
	ld	(hl), #0x08
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:27: INT8 floor = 114;
	ld	hl, #_floor
	ld	(hl), #0x72
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:30: UINT8 activePlatform = 1;
	ld	hl, #_activePlatform
	ld	(hl), #0x01
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:31: UINT8 platformSpeed = 4;
	ld	hl, #_platformSpeed
	ld	(hl), #0x04
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:32: UINT8 platformWaitLength = 4;
	ld	hl, #_platformWaitLength
	ld	(hl), #0x04
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:33: enum PlatformDirection platformDirection = LEFT;
	ld	hl, #_platformDirection
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:34: UINT8 waitCount = 0;
	ld	hl, #_waitCount
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:35: UBYTE gameActive = 1;
	ld	hl, #_gameActive
	ld	(hl), #0x01
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:36: UINT16 score = 0;
	ld	hl, #_score
	ld	(hl), #0x00
	inc	hl
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:286: UINT8 fontNumBase = 0x01;
	ld	hl, #_fontNumBase
	ld	(hl), #0x01
;--------------------------------------------------------
; Home
...
;--------------------------------------------------------
	.area _CODE
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:38: void performantDelay(UINT8 numloops)
;	---------------------------------
; Function performantDelay
; ---------------------------------
_performantDelay::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:41: for(i=0; i<numloops;i++){
	ld	c, #0x00
00103$:
	ld	a, c
	ldhl	sp,	#2
	sub	a, (hl)
	ret	NC
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:42: wait_vbl_done();
	call	_wait_vbl_done
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:41: for(i=0; i<numloops;i++){
	inc	c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:44: }
	jr	00103$
_gravity:
	.db #0xfe	; -2
_BASE_JUMP_SPEED:
	.db #0x0f	;  15
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:46: void playSound(enum Sound sound){
;	---------------------------------
; Function playSound
; ---------------------------------
_playSound::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:47: switch(sound){
	ldhl	sp,	#2
	ld	a, (hl)
	or	a, a
	jr	Z, 00101$
	...
	jr	Z, 00102$
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:48: case JUMP:
00101$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:49: NR10_REG = 0x16; 
	ld	a, #0x16
	ldh	(_NR10_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:50: NR11_REG = 0x40;
	ld	a, #0x40
	ldh	(_NR11_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:51: NR12_REG = 0x73;  
	ld	a, #0x73
	ldh	(_NR12_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:52: NR13_REG = 0x00;   
	ld	a, #0x00
	ldh	(_NR13_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:53: NR14_REG = 0xC3;	        
	ld	a, #0xc3
	ldh	(_NR14_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:54: break;
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:55: case GAME_OVER:
00102$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:56: NR10_REG = 0x79;
	ld	a, #0x79
	ldh	(_NR10_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:57: NR11_REG = 0xC2;
	ld	a, #0xc2
	ldh	(_NR11_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:58: NR12_REG = 0x54;
	ld	a, #0x54
	ldh	(_NR12_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:59: NR13_REG = 0x73;
	ld	a, #0x73
	ldh	(_NR13_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:60: NR14_REG = 0x86;
	ld	a, #0x86
	ldh	(_NR14_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:62: }
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:63: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:65: void movePlatform(struct MetaSprite* platform, UINT8 x, UINT8 y)
;	---------------------------------
; Function movePlatform
; ---------------------------------
_movePlatform::
	add	sp, #-3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:67: move_sprite(platform->spriteIds[0], x, y);
	ldhl	sp,	#8
	ld	a, (hl)
	ldhl	sp,	#0
	ld	(hl), a
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	a, (hl)
	ld	(bc), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:68: move_sprite(platform->spriteIds[1], x + spriteSize, y);
	ld	a, (hl)
	ld	hl, #_spriteSize
	add	a, (hl)
	ld	l, e
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	a, (hl)
	ld	(bc), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:69: move_sprite(platform->spriteIds[2], x + (spriteSize * 2), y);
	ld	a, (#_spriteSize)
	add	a, a
	ldhl	sp,	#1
	ld	c, (hl)
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	(de), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:69: move_sprite(platform->spriteIds[2], x + (spriteSize * 2), y);
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:70: }
	add	sp, #3
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:72: void movePlayer(struct MetaSprite* player, UINT8 x, UINT8 y)
;	---------------------------------
; Function movePlayer
; ---------------------------------
_movePlayer::
	add	sp, #-3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:74: move_sprite(player->spriteIds[0], x, y);
	ldhl	sp,	#8
	ld	a, (hl)
	ldhl	sp,	#0
	ld	(hl), a
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	a, (hl)
	ld	(bc), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:75: move_sprite(player->spriteIds[1], x + spriteSize, y);
	ld	a, (hl)
	ld	hl, #_spriteSize
	add	a, (hl)
	ld	l, e
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	a, (hl)
	ld	(bc), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:76: move_sprite(player->spriteIds[2], x, y + spriteSize);
	dec	hl
	dec	hl
	ld	a, (hl)
	ld	hl, #_spriteSize
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	a, (hl)
	ld	(bc), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:77: move_sprite(player->spriteIds[3], x + spriteSize, y + spriteSize);
	dec	hl
	ld	a, (hl)
	ld	hl, #_spriteSize
	add	a, (hl)
...
;P:/_lib/gbdk/include/gb/gb.h:1219: itm->y=y, itm->x=x;
	...
	ld	(hl), c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:77: move_sprite(player->spriteIds[3], x + spriteSize, y + spriteSize);
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:78: }
	add	sp, #3
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:80: void initPlatform(UINT8 id, UINT8 x, UINT8 y)
;	---------------------------------
; Function initPlatform
; ---------------------------------
_initPlatform::
	dec	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:82: platforms[id].x = x; //76
	ldhl	sp,	#3
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	ld	a, (hl)
	ld	(de), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:83: platforms[id].y = y; //130
	ld	hl, #0x0005
	add	hl, bc
	ld	e, l
	ld	d, h
	...
	ld	a, (hl)
	ld	(de), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:84: platforms[id].width = 24;
	ld	hl, #0x0006
	add	hl, bc
	ld	(hl), #0x18
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:85: platforms[id].height = 8;
	ld	hl, #0x0007
	add	hl, bc
	ld	(hl), #0x08
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:86: platforms[id].yAtJump = y;
	ld	hl, #0x0008
	add	hl, bc
	ld	e, l
	ld	d, h
	...
	ld	a, (hl)
	ld	(de), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:87: set_sprite_tile(5 + (id * 3),0);
	dec	hl
	dec	hl
	ld	a, (hl)
	ld	e, a
...
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	...
	inc	hl
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:88: platforms[id].spriteIds[0] = 5 + (id * 3);
	ld	a, e
	ld	(bc), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:89: set_sprite_tile(6 + (id * 3),1);
	ldhl	sp,	#0
	ld	a, (hl)
	add	a, #0x06
	ld	e, a
...
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	...
	inc	hl
	ld	(hl), #0x01
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:90: platforms[id].spriteIds[1] = 6 + (id * 3);
	ld	l, c
	ld	h, b
	inc	hl
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:91: set_sprite_tile(7 + (id * 3),2);
	ldhl	sp,	#0
	ld	a, (hl)
	add	a, #0x07
	ld	e, a
...
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	...
	inc	hl
	ld	(hl), #0x02
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:92: platforms[id].spriteIds[2] = 7 + (id * 3);
	ld	l, c
	ld	h, b
	inc	hl
	inc	hl
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:94: movePlatform(&platforms[id], platforms[id].x, platforms[id].y);
	ldhl	sp,	#5
	ld	a, (hl)
	push	af
	inc	sp
	...
	call	_movePlatform
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:95: }
	inc	sp
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:97: void initPlayer(UINT8 x)
;	---------------------------------
; Function initPlayer
; ---------------------------------
_initPlayer::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:99: player.x = x;
	ld	bc, #_player+0
	ld	de, #(_player + 0x0004)
	ldhl	sp,	#2
	ld	a, (hl)
	ld	(de), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:100: player.y = 84;
	ld	hl, #(_player + 0x0005)
	ld	(hl), #0x54
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:101: player.width = 16;
	ld	hl, #(_player + 0x0006)
	ld	(hl), #0x10
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:102: player.height = 16;
	ld	hl, #(_player + 0x0007)
	ld	(hl), #0x10
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 0x0006)
	ld	(hl), #0x03
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:104: player.spriteIds[0] = 1;
	ld	a, #0x01
	ld	(bc), a
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 0x000a)
	ld	(hl), #0x04
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:106: player.spriteIds[1] = 2;
	ld	hl, #(_player + 0x0001)
	ld	(hl), #0x02
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 0x000e)
	ld	(hl), #0x05
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:108: player.spriteIds[2] = 3;
	ld	hl, #(_player + 0x0002)
	ld	(hl), #0x03
;P:/_lib/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 0x0012)
	ld	(hl), #0x06
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:110: player.spriteIds[3] = 4;
	ld	hl, #(_player + 0x0003)
	ld	(hl), #0x04
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:112: movePlayer(&player, player.x, player.y);
	...
	call	_movePlayer
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:113: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:115: INT8 wouldHitSurface(struct MetaSprite* platform)
;	---------------------------------
; Function wouldHitSurface
; ---------------------------------
_wouldHitSurface::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:117: if(platform->y <= platform->yAtJump){
	pop	bc
	pop	de
	push	de
	push	bc
	...
	ld	a, e
	sub	a, c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:118: return platform->yAtJump;
	ret	NC
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:120: return -1;
	ld	e, #0xff
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:121: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:123: BOOLEAN isCollision(){
;	---------------------------------
; Function isCollision
; ---------------------------------
_isCollision::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:124: if(platforms[activePlatform].y < 100){
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	sub	a, #0x64
	jr	NC, 00106$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:127: return platforms[activePlatform].x < 96;
	inc	bc
	inc	bc
	inc	bc
	inc	bc
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:125: switch(platformDirection){
	...
	jr	Z, 00102$
	jr	00103$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:126: case LEFT:
00101$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:127: return platforms[activePlatform].x < 96;
	ld	a, (bc)
	sub	a, #0x60
	...
	ld	e, a
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:128: case RIGHT:
00102$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:129: return platforms[activePlatform].x > 56 && platforms[activePlatform].x < 240;
	ld	a, (bc)
	ld	c, a
	ld	a, #0x38
	sub	a, c
...
00110$:
	ld	e, #0x01
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:130: default: 
00103$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:131: return 0;
	ld	e, #0x00
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:132: }
00106$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:134: return 0;
	ld	e, #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:135: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:137: BOOLEAN platformIsUnderPlayer(){
;	---------------------------------
; Function platformIsUnderPlayer
; ---------------------------------
_platformIsUnderPlayer::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:138: if(platforms[activePlatform].y <= 102){
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	sub	a, e
	jr	C, 00106$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:141: return platforms[activePlatform].x < 90;
	inc	bc
	inc	bc
	inc	bc
	inc	bc
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:139: switch(platformDirection){
	ld	a, (#_platformDirection)
	or	a, a
	jr	Z, 00101$
	ld	a, (#_platformDirection)
	...
	jr	Z, 00102$
	jr	00103$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:140: case LEFT:
00101$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:141: return platforms[activePlatform].x < 90;
	ld	a, (bc)
	sub	a, #0x5a
	...
	ld	e, a
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:142: case RIGHT:
00102$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:143: return platforms[activePlatform].x > 62 && platforms[activePlatform].x < 240;
	ld	a, (bc)
	ld	c, a
	ld	a, #0x3e
	sub	a, c
...
00110$:
	ld	e, #0x01
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:144: default: 
00103$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:145: return 0;
	ld	e, #0x00
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:146: }
00106$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:148: return 0;
	ld	e, #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:149: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:151: void jump()
;	---------------------------------
; Function jump
; ---------------------------------
_jump::
	add	sp, #-4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:155: if(jumping == 0) {
	ld	a, (#_jumping)
	or	a, a
	jr	NZ, 00103$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:156: playSound(JUMP);    
	xor	a, a
	push	af
	inc	sp
	call	_playSound
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:157: jumping = 1;
	ld	hl, #_jumping
	ld	(hl), #0x01
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:158: for (UINT8 i = 0; i < PLATFORM_COUNT; i++)
	ld	c, #0x00
00113$:
	ld	a, c
	sub	a, #0x04
	jr	NC, 00101$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:160: platforms[i].yAtJump = platforms[i].y;
	ld	b, #0x00
	ld	l, c
	ld	h, b
	add	hl, hl
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:158: for (UINT8 i = 0; i < PLATFORM_COUNT; i++)
	...
	jr	00113$
00101$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:162: currentSpeedY = BASE_JUMP_SPEED;
	ld	a, (#_BASE_JUMP_SPEED)
	ld	(#_currentSpeedY),a
00103$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:164: currentSpeedY = currentSpeedY + gravity;
	ld	hl, #_gravity
	ld	e, (hl)
	...
	add	a, e
	ld	(hl), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:165: if(currentSpeedY < -(BASE_JUMP_SPEED - gravity)) currentSpeedY = 0;
	ld	a, (#_BASE_JUMP_SPEED)
	ld	c, a
	rla
	sbc	a, a
...
00163$:
	...
	ld	hl, #_currentSpeedY
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:167: for (UINT8 i = 0; i < PLATFORM_COUNT; i++)
00127$:
	xor	a, a
	ldhl	sp,	#3
	ld	(hl), a
00116$:
	...
	sub	a, #0x04
	jp	NC, 00118$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:169: if(platformIsUnderPlayer()){
	call	_platformIsUnderPlayer
	push	hl
	ldhl	sp,	#4
	ld	(hl), e
	pop	hl
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:170: platforms[i].yAtJump = 100;
	ldhl	sp,	#3
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:170: platforms[i].yAtJump = 100;
	...
	ld	(hl), #0x64
00107$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:172: platforms[i].y += currentSpeedY;    
	ld	hl, #_platforms
	add	hl, bc
	ld	c, l
	ld	b, h
	...
	pop	af
	ld	(hl), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:173: possibleSurfaceY = wouldHitSurface(&platforms[i]);
	ld	e, c
	ld	d, b
	push	bc
	push	de
	...
	ldhl	sp,	#0
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:174: if(currentSpeedY == 0 || possibleSurfaceY > -1){
	ld	a, (#_currentSpeedY)
	or	a, a
	jr	Z, 00108$
	ldhl	sp,	#0
...
00165$:
	jr	NC, 00109$
00108$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:176: jumping = 0;
	ld	hl, #_jumping
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:177: platforms[i].y = platforms[i].yAtJump;
	ld	hl, #0x0008
	add	hl, bc
	ld	a, (hl)
	ldhl	sp,	#1
	...
	ld	(hl), a
00109$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:179: movePlatform(&platforms[i], platforms[i].x, platforms[i].y);
	ldhl	sp,#1
	ld	a, (hl+)
	ld	e, a
	ld	d, (hl)
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:167: for (UINT8 i = 0; i < PLATFORM_COUNT; i++)
	...
	jp	00116$
00118$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:181: }
	add	sp, #4
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:183: void updatePlayer()
;	---------------------------------
; Function updatePlayer
; ---------------------------------
_updatePlayer::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:185: movePlayer(&player, player.x, player.y);
	ld	hl, #_player + 5
	ld	b, (hl)
	ld	hl, #_player + 4
	ld	c, (hl)
	...
	call	_movePlayer
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:186: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:188: UINT8 getRand(UINT8 min, UINT8 max){
;	---------------------------------
; Function getRand
; ---------------------------------
_getRand::
	dec	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:189: return (((UINT8)rand()) % ((UINT8)max + (UINT8) 1 - min)) + min;
	call	_rand
	ldhl	sp,	#0
	ld	(hl), e
	ldhl	sp,	#4
	...
	add	a, e
	ld	e, a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:190: }
	inc	sp
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:192: void setScore(BOOLEAN increment){
;	---------------------------------
; Function setScore
; ---------------------------------
_setScore::
	add	sp, #-3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:193: if(increment) score++;
	ldhl	sp,	#5
	ld	a, (hl)
	or	a, a
	jr	Z, 00122$
	...
	inc	(hl)
00156$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:194: for (UINT8 i = 0; i < 4; i++)
00122$:
	ld	c, #0x00
00116$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:196: windowmap[7+i] = (unsigned char) (0x23);
	ld	a,c
	cp	a,#0x04
	jr	NC, 00103$
	add	a, #0x07
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:194: for (UINT8 i = 0; i < 4; i++)
	...
	jr	00116$
00103$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:200: windowmap[10] = (unsigned char) (0x23 + score);
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:199: if(score < 10){  
	ld	hl, #_score
	ld	a, (hl)
	sub	a, #0x0a
	inc	hl
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:200: windowmap[10] = (unsigned char) (0x23 + score);
	...
	jp	00118$
00113$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:204: UINT8 ones = score % 10;
	ld	hl, #0x000a
	push	hl
	ld	hl, #_score
	ld	a, (hl+)
	...
	ld	l, a
	push	hl
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:205: windowmap[9] = (unsigned char) (0x23 + tens);
	call	__moduint
	add	sp, #4
	ld	c, e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:204: UINT8 ones = score % 10;
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:202: else if(score < 100){
	ld	hl, #_score
	ld	a, (hl)
	sub	a, #0x64
	inc	hl
	...
	sbc	a, #0x00
	jr	NC, 00110$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:203: UINT8 tens = score / 10;
	push	bc
	ld	hl, #0x000a
	push	hl
	ld	hl, #_score
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:206: windowmap[10] = (unsigned char) (0x23 + ones);
	ld	a, c
	add	a, #0x23
	ld	(#(_windowmap + 0x000a)),a
	jp	00118$
00110$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:210: UINT8 tens = (score % 100) / 10;
	push	bc
	ld	hl, #0x0064
	push	hl
	ld	hl, #_score
	...
	ld	l, a
	push	hl
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:212: windowmap[8] = (unsigned char) (0x23 + huns);
	call	__moduint
	add	sp, #4
	ld	hl, #0x000a
	push	hl
	...
	pop	bc
	ld	b, e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:208: else if(score < 1000){
	ld	hl, #_score
	ld	a, (hl)
	sub	a, #0xe8
	inc	hl
	...
	sbc	a, #0x03
	jr	NC, 00107$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:209: UINT8 huns = score / 100;
	push	bc
	ld	hl, #0x0064
	push	hl
	ld	hl, #_score
	...
	ld	a, e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:210: UINT8 tens = (score % 100) / 10;
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:211: UINT8 ones = score % 10;
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:212: windowmap[8] = (unsigned char) (0x23 + huns);
	add	a, #0x23
	ld	(#(_windowmap + 0x0008)),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:213: windowmap[9] = (unsigned char) (0x23 + tens);
	ld	a, b
	add	a, #0x23
	ld	(#(_windowmap + 0x0009)),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:214: windowmap[10] = (unsigned char) (0x23 + ones);
	ld	a, c
	add	a, #0x23
	ld	(#(_windowmap + 0x000a)),a
	jr	00118$
00107$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:216: else if(score < 10000){
	ld	hl, #_score
	ld	a, (hl)
	sub	a, #0x10
	inc	hl
	...
	sbc	a, #0x27
	jr	NC, 00118$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:217: UINT8 thous = score / 1000;
	push	bc
	ld	hl, #0x03e8
	push	hl
	ld	hl, #_score
	...
	ldhl	sp,	#0
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:218: UINT8 huns = (score % 1000) / 100;
	push	bc
	ld	hl, #0x03e8
	push	hl
	ld	hl, #_score
	...
	pop	bc
	ldhl	sp,	#1
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:219: UINT8 tens = (score % 100) / 10;
	ld	a, e
	ld	(hl+), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:220: UINT8 ones = score % 10;
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:221: windowmap[7] = (unsigned char) (0x23 + thous);
	ld	a, b
	ld	(hl-), a
	dec	hl
	ld	a, (hl)
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:222: windowmap[8] = (unsigned char) (0x23 + huns);
	ldhl	sp,	#1
	ld	a, (hl)
	add	a, #0x23
	ld	(#(_windowmap + 0x0008)),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:223: windowmap[9] = (unsigned char) (0x23 + tens);
	ldhl	sp,	#2
	ld	a, (hl)
	add	a, #0x23
	ld	(#(_windowmap + 0x0009)),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:224: windowmap[10] = (unsigned char) (0x23 + ones);
	ld	a, c
	add	a, #0x23
	ld	(#(_windowmap + 0x000a)),a
00118$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:226: }
	add	sp, #3
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:228: void updateScore(){
;	---------------------------------
; Function updateScore
; ---------------------------------
_updateScore::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:229: set_win_tiles(0,0,11,1, windowmap);
	ld	hl, #_windowmap
	push	hl
	ld	de, #0x010b
	push	de
...
;P:/_lib/gbdk/include/gb/gb.h:1015: WX_REG=x, WY_REG=y;
	...
	ld	a, #0x88
	ldh	(_WY_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:230: move_win(7,136);
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:231: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:233: void changeActivePlatform(){
;	---------------------------------
; Function changeActivePlatform
; ---------------------------------
_changeActivePlatform::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:234: activePlatform = activePlatform + 1 > 3 ? 0 : activePlatform + 1;
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	inc	bc
...
00104$:
	ld	hl, #_activePlatform
	ld	(hl), c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:235: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:237: void randomiseValues(BOOLEAN incrementScore){
;	---------------------------------
; Function randomiseValues
; ---------------------------------
_randomiseValues::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:238: if(platforms[activePlatform].y == 100){
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	sub	a, #0x64
	ret	NZ
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:239: waitCount = 0;
	ld	hl, #_waitCount
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:240: platformWaitLength = getRand(2,15); 
	ld	de, #0x0f02
	push	de
	call	_getRand
	add	sp, #2
	ld	hl, #_platformWaitLength
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:241: platformSpeed = getRand(8,10);
	ld	de, #0x0a08
	push	de
	call	_getRand
	add	sp, #2
	ld	hl, #_platformSpeed
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:242: platformDirection = getRand(0,1);
	ld	a, #0x01
	push	af
	inc	sp
	xor	a, a
	...
	ld	hl, #_platformDirection
	ld	(hl), e
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:243: initPlatform(activePlatform, 76, 100);
	ld	de, #0x644c
	push	de
	ld	a, (#_activePlatform)
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:245: changeActivePlatform();
	call	_changeActivePlatform
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:247: UINT8 x = platformDirection ? 0xF0 : 170; 
	ld	hl, #_platformDirection
	ld	a, (hl)
	or	a, a
	jr	Z, 00105$
...
00106$:
	ld	a, c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:248: initPlatform(activePlatform, x, 60);
	ld	h, #0x3c
	push	hl
	inc	sp
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:249: setScore(incrementScore);
	ldhl	sp,	#2
	ld	a, (hl)
	push	af
	inc	sp
	call	_setScore
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:251: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:253: void loadFonts(){
;	---------------------------------
; Function loadFonts
; ---------------------------------
_loadFonts::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:256: font_init();
	call	_font_init
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:257: min_font = font_load(font_min);
	ld	hl, #_font_min
	push	hl
	call	_font_load
	add	sp, #2
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:258: font_set(min_font);
	push	de
	call	_font_set
	add	sp, #2
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:259: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:261: void showStartScreen(){
;	---------------------------------
; Function showStartScreen
; ---------------------------------
_showStartScreen::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:262: set_win_tiles(0,0,20,18, Splash);
	ld	hl, #_Splash
	push	hl
	ld	de, #0x1214
	push	de
...
;P:/_lib/gbdk/include/gb/gb.h:1015: WX_REG=x, WY_REG=y;
	...
	ld	a, #0x00
	ldh	(_WY_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:264: SHOW_WIN;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x20
	ldh	(_LCDC_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:265: waitpad(J_START);
	ld	a, #0x80
	push	af
	inc	sp
	call	_waitpad
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:266: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:268: void showGameOverScreen(){
;	---------------------------------
; Function showGameOverScreen
; ---------------------------------
_showGameOverScreen::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:269: initPlatform(0, 170, 100);
	ld	de, #0x64aa
	push	de
	xor	a, a
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:270: initPlatform(1, 170, 60);
	ld	de, #0x3caa
	push	de
	ld	a, #0x01
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:271: initPlatform(2, 170, 60);
	ld	de, #0x3caa
	push	de
	ld	a, #0x02
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:272: initPlatform(3, 170, 60);
	ld	de, #0x3caa
	push	de
	ld	a, #0x03
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:273: initPlayer(170);
	ld	a, #0xaa
	push	af
	inc	sp
	call	_initPlayer
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:274: set_win_tiles(0,0,20,18, Splash);
	ld	hl, #_Splash
	push	hl
	ld	de, #0x1214
	push	de
...
;P:/_lib/gbdk/include/gb/gb.h:1015: WX_REG=x, WY_REG=y;
	...
	ld	a, #0x00
	ldh	(_WY_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:276: SHOW_WIN;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x20
	ldh	(_LCDC_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:277: waitpad(J_START);
	ld	a, #0x80
	push	af
	inc	sp
	call	_waitpad
...
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:278: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:280: void seedRandom(){
;	---------------------------------
; Function seedRandom
; ---------------------------------
_seedRandom::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:281: uint16_t seed = LY_REG;
	ldh	a, (_LY_REG+0)
	ld	c, a
	ld	b, #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:282: seed |= (uint16_t)DIV_REG << 8;
	ldh	a, (_DIV_REG+0)
	ld	e, a
	ld	a, #0x00
	or	a, c
	...
	or	a, b
	ld	b, a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:283: initrand(seed);
	push	bc
	call	_initrand
	add	sp, #2
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:284: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:288: BOOLEAN activePlatformIsWaiting(){
;	---------------------------------
; Function activePlatformIsWaiting
; ---------------------------------
_activePlatformIsWaiting::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:289: if(waitCount < platformWaitLength){
	ld	a, (#_waitCount)
	ld	hl, #_platformWaitLength
	sub	a, (hl)
	jr	NC, 00102$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:290: waitCount++;
	ld	hl, #_waitCount
	inc	(hl)
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:291: return 1;
	ld	e, #0x01
	ret
00102$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:293: return 0;
	ld	e, #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:294: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:296: void moveActivePlatform(){
;	---------------------------------
; Function moveActivePlatform
; ---------------------------------
_moveActivePlatform::
	add	sp, #-9
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:297: if(activePlatformIsWaiting()) return;
	call	_activePlatformIsWaiting
	ld	a, e
	or	a, a
	jp	NZ,00114$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:301: if(platforms[activePlatform].x - platformSpeed > 76){
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	inc	hl
	ld	(hl), a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:299: switch(platformDirection){
	ld	a, (#_platformDirection)
	or	a, a
	jr	Z, 00103$
	ld	a, (#_platformDirection)
	...
	jp	Z,00111$
	jp	00114$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:300: case LEFT:
00103$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:301: if(platforms[activePlatform].x - platformSpeed > 76){
;c
	ld	de, #_platforms
...
00144$:
	jr	NC, 00105$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:302: platforms[activePlatform].x -= platformSpeed;
	ldhl	sp,	#4
	ld	a, (hl)
	ld	hl, #_platformSpeed
	sub	a, (hl)
	...
	ld	l, a
	ld	(hl), c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:303: movePlatform(&platforms[activePlatform], platforms[activePlatform].x, platforms[activePlatform].y);
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	jp	00114$
00105$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:306: movePlatform(&platforms[activePlatform], 76, platforms[activePlatform].y);
	ld	hl, #0x0005
	add	hl, bc
	ld	d, (hl)
	ld	e,#0x4c
	...
	call	_movePlatform
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:307: randomiseValues(TRUE);
	ld	a, #0x01
	push	af
	inc	sp
	call	_randomiseValues
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:309: break;
	jp	00114$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:311: if((platforms[activePlatform].x <= 255 && platforms[activePlatform].x >= 224) || platforms[activePlatform].x + platformSpeed < 76){
00111$:
;c
	ldhl	sp,#7
	ld	a, (hl+)
...
00146$:
	jr	NC, 00109$
00108$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:312: platforms[activePlatform].x += platformSpeed;
	ldhl	sp,	#6
	ld	a, (hl)
	ld	hl, #_platformSpeed
	add	a, (hl)
	...
	ld	l, a
	ld	(hl), c
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:313: movePlatform(&platforms[activePlatform], platforms[activePlatform].x, platforms[activePlatform].y);
	ld	hl, #_activePlatform
	ld	c, (hl)
	ld	b, #0x00
	ld	l, c
	...
	jr	00114$
00109$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:316: movePlatform(&platforms[activePlatform], 76, platforms[activePlatform].y);
	ld	hl, #0x0005
	add	hl, bc
	ld	d, (hl)
	ld	e,#0x4c
	...
	call	_movePlatform
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:317: randomiseValues(TRUE);
	ld	a, #0x01
	push	af
	inc	sp
	call	_randomiseValues
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:320: }
00114$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:321: }
	add	sp, #9
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:323: void loop(){
;	---------------------------------
; Function loop
; ---------------------------------
_loop::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:324: while (1)
00109$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:327: if(isCollision()) return;
	call	_isCollision
	ld	a, e
	or	a, a
	ret	NZ
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:330: if((joypad() & J_A) || jumping == 1){
	call	_joypad
	bit	4, e
	jr	NZ, 00103$
	ld	a, (#_jumping)
	...
	jr	NZ, 00104$
00103$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:331: jump();
	call	_jump
00104$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:335: if(isCollision()) return;
	call	_isCollision
	ld	a, e
	or	a, a
	ret	NZ
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:338: moveActivePlatform();    
	call	_moveActivePlatform
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:340: updateScore();
	call	_updateScore
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:342: performantDelay(5);
	ld	a, #0x05
	push	af
	inc	sp
	call	_performantDelay
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:343: gbt_update();
	call	_gbt_update
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:345: }
	jr	00109$
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:347: void startBGM(){
;	---------------------------------
; Function startBGM
; ---------------------------------
_startBGM::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:348: disable_interrupts();
	call	_disable_interrupts
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:349: gbt_play(song_Data, 2, 2);
	ld	de, #0x0202
	push	de
	ld	hl, #_song_Data
	push	hl
	call	_gbt_play
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:350: gbt_loop(1);
	ld	a, #0x01
	push	af
	inc	sp
	call	_gbt_loop
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:352: set_interrupts(VBL_IFLAG);
	ld	a, #0x01
	push	af
	inc	sp
	call	_set_interrupts
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:353: enable_interrupts();
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:354: }
	jp  _enable_interrupts
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:356: void playGameOverSFX(){
;	---------------------------------
; Function playGameOverSFX
; ---------------------------------
_playGameOverSFX::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:357: playSound(GAME_OVER);
	ld	a, #0x01
	push	af
	inc	sp
	call	_playSound
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:358: gbt_stop();
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:359: }
	jp  _gbt_stop
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:361: void init()
;	---------------------------------
; Function init
; ---------------------------------
_init::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:364: currentSpeedY = 0;
	ld	hl, #_currentSpeedY
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:365: jumping = 0;
	ld	hl, #_jumping
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:366: spriteSize = 8;
	ld	hl, #_spriteSize
	ld	(hl), #0x08
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:367: floor = 114;
	ld	hl, #_floor
	ld	(hl), #0x72
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:368: platformSpeed = 6;
	ld	hl, #_platformSpeed
	ld	(hl), #0x06
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:369: platformWaitLength = 4;
	ld	hl, #_platformWaitLength
	ld	(hl), #0x04
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:370: waitCount = 0;
	ld	hl, #_waitCount
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:371: gameActive = 1;
	ld	hl, #_gameActive
	ld	(hl), #0x01
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:372: score = 0;
	ld	hl, #_score
	ld	a, #0x00
	ld	(hl+), a
	ld	(hl), #0x00
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:373: setScore(FALSE);
	xor	a, a
	push	af
	inc	sp
	call	_setScore
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:376: changeActivePlatform();
	call	_changeActivePlatform
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:377: randomiseValues(FALSE);
	xor	a, a
	push	af
	inc	sp
	call	_randomiseValues
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:379: updateScore();
	call	_updateScore
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:382: set_win_tiles(0,0,11,1, windowmap);
	ld	hl, #_windowmap
	push	hl
	ld	de, #0x010b
	push	de
...
;P:/_lib/gbdk/include/gb/gb.h:1015: WX_REG=x, WY_REG=y;
	...
	ld	a, #0x88
	ldh	(_WY_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:386: set_sprite_data(0,7,Sprites);
	ld	hl, #_Sprites
	push	hl
	ld	a, #0x07
	push	af
	...
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:389: initPlatform(0, 76, 100);
	ld	de, #0x644c
	push	de
	xor	a, a
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:390: initPlatform(1, 170, 60);
	ld	de, #0x3caa
	push	de
	ld	a, #0x01
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:391: initPlatform(2, 170, 60);
	ld	de, #0x3caa
	push	de
	ld	a, #0x02
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:392: initPlatform(3, 170, 60);
	ld	de, #0x3caa
	push	de
	ld	a, #0x03
	push	af
	...
	call	_initPlatform
	add	sp, #3
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:393: initPlayer(80);
	ld	a, #0x50
	push	af
	inc	sp
	call	_initPlayer
	inc	sp
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:396: SHOW_SPRITES;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x02
	ldh	(_LCDC_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:397: DISPLAY_ON;
	ldh	a, (_LCDC_REG+0)
	or	a, #0x80
	ldh	(_LCDC_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:398: }
	ret
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:400: void main()
;	---------------------------------
; Function main
; ---------------------------------
_main::
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:403: NR52_REG = 0x80; // is 1000 0000 in binary and turns on sound
	ld	a, #0x80
	ldh	(_NR52_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:404: NR50_REG = 0x77; // sets the volume for both left and right channel just set to max 0x77
	ld	a, #0x77
	ldh	(_NR50_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:405: NR51_REG = 0xFF; // is 1111 1111 in binary, select which chanels we want to use in this case all of them. One bit for the L one bit for the R of all four channels
	ld	a, #0xff
	ldh	(_NR51_REG+0),a
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:408: loadFonts();
	call	_loadFonts
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:409: set_bkg_data(0,47, SplashTiles);
	ld	hl, #_SplashTiles
	push	hl
	ld	a, #0x2f
	push	af
	...
	call	_set_bkg_data
	add	sp, #4
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:410: showStartScreen();
	call	_showStartScreen
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:411: seedRandom();
	call	_seedRandom
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:413: while(1){
00102$:
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:414: startBGM();
	call	_startBGM
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:415: init();
	call	_init
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:416: loop();
	call	_loop
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:417: playGameOverSFX();
	call	_playGameOverSFX
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:418: showGameOverScreen();
	call	_showGameOverScreen
;P:\04_Computer_Science\C_CPP\Gameboy\00_jp_up\main.c:420: }
	jr	00102$
	.area _CODE
	.area _CABS (ABS)
